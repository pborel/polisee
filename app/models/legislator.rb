class Legislator < ActiveRecord::Base
  ...
  def self.query_sunlight_data
    ...
    (1..11).each do |page_number|
      reps_search = sun_client.all_legislators(page_number)
  ...
  def self.query_twitter_images
    ...
    # while legislator_without_image
        Leglegislator_without_image.first(180).each do |legislator|
          if legislator.twitter_id.nil?
            legislator.image = "https://lh4.ggpht.com/B2UjZIJ0iwp0LfkUnITqp_iYek9PWEXuXLOHl3XYPMR_2zEGsHPR6ruu4OeQKOfvJnJ8=w300-rw"
          else
